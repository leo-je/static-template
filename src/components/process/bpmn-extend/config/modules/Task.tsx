...
import PrefixLabelSelect from '../../../bpmn/components/prefix-label-select';
...
const RoleOption = (): JSX.Element => {
  let roleList = [{ label: '发起人', value: 'startUser' },
  { label: '部门经理', value: 'bumenjingli' },]
  return (
  <>
    {roleList?.map((item) => {
      return <ElOption {...item} />;
 ...
 */
    role: {
      ...
      filterable: true,
      vSlots: {
        default: (): JSX.Element => RoleOption(),
      },
    },
    /**
     * 循环基数
...
const BaseTaskProperties = {
  ...TaskBaseGroupProperties,
  properties: {
    ...TaskBaseGroupProperties.properties,
    loopCharacteristics: {
      component: PrefixLabelSelect,
      prefixTitle: '回路特性',
      vSlots: {
